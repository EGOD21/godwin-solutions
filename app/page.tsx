...
const websites = [
  ...
  },
  {
    ...
    description: 'Strategic consulting and organizational development services for forward-thinking companies.',
      ...
      <div className="relative">
        <div className="container-max section-padding">
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-godwin-blue to-blue-800 rounded-2xl mb-6 shadow-lg">
                <span className="text-white font-bold text-2xl font-serif">GS</span>
              </div>
            </div>
          ...
          <div className="mt-24 text-center animate-fade-in">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-10 lg:p-16 max-w-5xl mx-auto">
              ...
              <p className="text-xl lg:text-2xl text-slate-700 mb-10 leading-relaxed font-light max-w-3xl mx-auto">
                For inquiries, partnerships, or to learn more about our services, 
